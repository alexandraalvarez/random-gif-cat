<template>
    ...
    <div class="row d-flex justify-content-center my-0 mx-0 ">
        <div class="col-md-12 colNotPink">
                ...
                <div id="card">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-prepend ml-3 color-redondeado input-group-text color-show" :style="style">
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-12 colNotPink">
            <a href="#" class="btn btn-lg" @click="GetMyCat">¡Quiero mi gatito!</a>
            <img :src="url" class="img-fluid d-block mt-5 mb-5">
        </div>
